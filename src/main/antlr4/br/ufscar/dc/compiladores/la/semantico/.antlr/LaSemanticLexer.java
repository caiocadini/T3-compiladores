...
public class LaSemanticLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"ALGORITMO", "FIM_ALGORITMO", "LIT", "INT", "REAL", "LOG", "REG", "FIM_REG", 
			"VAR", "CONST", "VERDADEIRO", "FALSO", "ENDERECO", "PONTEIRO", "PONTO", 
			"ABRE_VETOR", "FECHA_VETOR", "DELIM", "ABREPAR", "FECHAPAR", "COMMA", 
			"CMD_LEIA", "CMD_ESCREVA", "CMD_SE", "CMD_FIMSE", "CMD_SENAO", "CMD_ENTAO", 
			"CMD_CASO", "CMD_FIMCASO", "CMD_PARA", "CMD_FIMPARA", "CMD_ENQUANTO", 
